          ...
          <div className="md:col-span-8">
            ...
            <h2 className="mt-10 font-display text-[clamp(2.5rem,7vw,6.5rem)] leading-[0.9] text-bone-100">
              <span className="block overflow-hidden">
                <span className="closer-line block">{t("titleLine1")}</span>
              </span>
              <span className="block overflow-hidden">
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <div className="closer-meta glass rounded-2xl p-6">
              <div className="flex items-center gap-3 border-b border-rule-soft pb-4">
                ...
                <span className="chip-mono text-bone-200">{t("availability")}</span>
              </div>
              <p className="mt-4 text-sm leading-relaxed text-bone-400">{t("body")}</p>
            </div>

            <Link
              href="/contact"
              data-cursor="cta"
              data-cursor-label={t("ctaCursor")}
            ...
            >
              <span className="z-10 transition-transform duration-300 group-hover:translate-x-0.5">
                {t("cta")}
              </span>
              <span
                aria-hidden
                className="z-10 transition-transform duration-300 group-hover:translate-x-0.5"
              >
                <MoveRight size={14} />
              </span>
